...
class E_Photo
{
     ...
     * @param int $is_reserved Whether the photo is reserved (1) or public (0)
     ...
     */
    public function __construct($title, $desc = '', $is_reserved = 0, $cat = [], $up_Date = 0, $likes = [], $comments = [])
    {
     ...
     * - Reserved (1): only certain users will be able to see the photo
     * - Public  (0): ALL users will be able to see the photo
     *
     * @param int $is_reserved The new Photo privacy
     */
     ...
     *
     * @return int Retrieves the visibility of the Photo
     */
